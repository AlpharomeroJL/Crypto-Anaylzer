...
| Phase 3 checklist: regime models, Kalman beta, sweep registry, performance optimization, promotion workflow | [phased_execution.md](components/phased_execution.md) | In progress | | | | | Regimes slice done; rest not started |
