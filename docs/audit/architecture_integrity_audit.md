...
| 16 | Document Romano–Wolf stub (NotImplementedError when CRYPTO_ANALYZER_ENABLE_ROMANOWOLF=1) in interfaces and implementation_ledger. | [DOC ONLY] | docs/spec/components/interfaces.md, docs/spec/implementation_ledger.md |
